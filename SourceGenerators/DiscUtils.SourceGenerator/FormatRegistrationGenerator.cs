...
public sealed class FormatRegistrationGenerator : IIncrementalGenerator
{
        ...
        ImmutableArray<Registration> registrations, bool isLibrary)
    {
        ...
        if (registrations.IsEmpty && dependencies.Count == 0) return;
        ...
        var setupName = SetupType(compilation.AssemblyName!);
        ...
        // Library dependencies are registered only when the application calls this entry point.
